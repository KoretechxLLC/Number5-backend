...
const MembershipSchema = joi.object({
  ...
  male_membership_amount: joi.number(),
  female_membership_amount: joi.number(),
  is_unlimited_guest_allowed: joi.boolean(),
  is_unlimited_visits: joi.boolean(),
  couple_membership_amount: joi.number(),
